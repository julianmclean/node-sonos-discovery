...
const TYPE = Object.freeze({
  ...
  Snooze: 'urn:schemas-upnp-org:service:AVTransport:1#SnoozeAlarm',
...
const TEMPLATES = Object.freeze({
  ...
  [TYPE.Snooze]: '<u:SnoozeAlarm xmlns:u="urn:schemas-upnp-org:service:AVTransport:1"><InstanceID>0</InstanceID><Duration>{duration}</Duration></u:SnoozeAlarm>',
